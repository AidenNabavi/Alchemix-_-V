...
pragma solidity ^0.8.28;
 //My Yield Token اها یعنی یک استخری از توکن ها  در این قرار داد کاربران به استختر های توکن ها را می دهند 
 //MYT الان در این یعنی یک استخر توکن که رای دهی کلا برای این است 
import { IERC20 } from "../lib/openzeppelin/contracts/token/ERC20/IERC20.sol";
import { IStrategyClassifier } from "../lib/interfaces/IStrategyClassifier.sol"; 
...
contract PerpetualGauge is ReentrancyGuard {
    ...
    /// @dev 📌This function has been made public for testing purposes only, just to be able to read its value; it has no effect on the function's behavior
